  ...
  <header class="sticky top-0 z-30 border-b border-black/10 bg-[#f7f7f4]/85 backdrop-blur-xl dark:border-white/10 dark:bg-[#101010]/85">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          v-if="user"
          class="hidden items-center gap-2 rounded-lg border border-black/10 bg-white px-3 py-1.5 dark:border-white/10 dark:bg-white/5 sm:flex"
        >
          <svg
...
const pageTitle = computed(() => {
  // For custom pages, use the menu item's label instead of generic "自定義頁面"
