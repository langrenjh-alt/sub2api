...
const currentValidation = ref<GeetestValidation | null>(null)
...
function invalidateValidation(event: 'invalid' | 'error'): void {
...
function getValidation(): GeetestValidation | null {
  return currentValidation.value
}

defineExpose({ reset, getValidation })
