...
function methodIcon(type: string): string {
  ...
  if (type === 'webmoney') return METHOD_ICONS.webmoney
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'webmoney') return 'border-[#1A5FB4] bg-sky-50 text-gray-900 shadow-sm dark:border-[#4C8DFF] dark:bg-sky-950 dark:text-gray-100'
