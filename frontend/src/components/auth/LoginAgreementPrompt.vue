<template>
  ...
  >
    <div class="flex items-start gap-2">
      <input
        ...
        type="checkbox"
        :checked="accepted"
        class="mt-[2px] h-4 w-4 flex-shrink-0 rounded border-gray-300 text-primary-600 focus:ring-[var(--geist-foreground-300)] dark:border-dark-600 dark:bg-dark-900"
  ...
  <Teleport to="body">
    <Transition name="agreement-fade">
      ...
      >
        <div class="w-full max-w-[600px] overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-black/10 dark:bg-dark-900 dark:ring-white/10">
