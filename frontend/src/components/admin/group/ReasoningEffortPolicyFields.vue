      ...
      <div v-if="mappings.length > 0" class="space-y-2">
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="flex h-11 w-11 items-center justify-center self-end rounded-lg text-gray-400 transition-colors hover:bg-red-50 hover:text-red-500 focus:outline-none focus:ring-2 focus:ring-[var(--geist-foreground-300)] dark:hover:bg-red-900/20 dark:hover:text-red-400"
