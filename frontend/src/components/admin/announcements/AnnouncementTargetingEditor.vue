<template>
  <div class="rounded-lg border border-[var(--geist-border-100)] bg-[var(--geist-background-200)] p-4 dark:border-[var(--geist-border-100)] dark:bg-[var(--geist-background-200)]">
