...
const commentsAnnouncement = computed(() => {
  const announcement = announcementStore.currentPopup
  return !props.preview && announcement?.comments_enabled ? announcement : null
})
