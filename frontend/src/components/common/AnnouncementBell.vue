<template>
  <div>
    ...
    <button
      @click="openModal"
      class="relative flex h-9 w-9 items-center justify-center rounded-lg text-gray-600 transition-all hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-dark-800"
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[620px] overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800"
            style="box-shadow: var(--geist-shadow-modal)"
            @click.stop
          >
            <!-- Header -->
            <div class="relative overflow-hidden border-b border-gray-200 px-6 py-5 dark:border-dark-700" style="background: var(--geist-background-200)">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  <div class="flex items-center gap-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg" style="background: var(--geist-background-300); color: var(--geist-foreground-100)">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <button
                    @click="closeModal"
                    class="flex h-9 w-9 items-center justify-center rounded-lg text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-dark-700 dark:hover:text-gray-300"
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :class="{ 'bg-gray-50 dark:bg-dark-700/20': !item.read_at }"
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      ...
                      style="background: var(--geist-background-300); color: var(--geist-foreground-100)"
                    >
                      <!-- Icon -->
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[780px] overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800"
            style="box-shadow: var(--geist-shadow-modal)"
            @click.stop
          >
            <!-- Header -->
            <div class="relative overflow-hidden border-b border-gray-200 px-8 py-6 dark:border-dark-700" style="background: var(--geist-background-200)">
              <div class="relative z-10 flex items-start justify-between gap-4">
                ...
                <button
                  @click="closeDetail"
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-dark-700 dark:hover:text-gray-300"
                  :aria-label="t('common.close')"
                >
                  <Icon name="x" size="md" />
                </button>
...
.overflow-y-auto::-webkit-scrollbar-thumb:hover {
  background: var(--geist-foreground-400);
}
</style>
