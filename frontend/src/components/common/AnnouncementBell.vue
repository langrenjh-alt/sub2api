  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="card w-full max-w-[620px] overflow-hidden"
            @click.stop
          >
            <!-- Header with Gradient -->
            <div class="relative overflow-hidden border-b border-[var(--geist-border-100)] px-6 py-5 dark:border-[var(--geist-border-100)]">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  <div class="flex items-center gap-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--geist-foreground-100)] text-[var(--geist-background-100)]">
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :key="item.id"
                  class="group relative flex items-center gap-4 border-b border-[var(--geist-border-100)] px-6 py-4 transition-all hover:bg-[var(--geist-background-200)] dark:border-[var(--geist-border-100)] dark:hover:bg-[var(--geist-background-300)]/30"
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--geist-foreground-100)] text-[var(--geist-background-100)]"
                    >
                      <!-- Pulse ring -->
                    ...
                    <div
                      v-else
                      class="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--geist-background-300)] text-[var(--geist-foreground-300)] dark:bg-[var(--geist-background-300)] dark:text-[var(--geist-foreground-400)]"
                    >
                  ...
                  <div
                    v-if="!item.read_at"
                    class="absolute left-0 top-0 h-full w-1 bg-[var(--geist-foreground-100)]"
                  ></div>
                </div>
              </div>
              <!-- Empty State -->
              <div v-else class="flex flex-col items-center justify-center py-16">
                <div class="relative mb-4">
                  <div class="flex h-20 w-20 items-center justify-center rounded-full bg-[var(--geist-background-300)]">
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="card w-full max-w-[780px] overflow-hidden"
            @click.stop
          >
              ...
              <div class="relative z-10 flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--geist-foreground-100)] text-[var(--geist-background-100)]">
                      <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-[var(--geist-foreground-100)] px-2.5 py-1 text-xs font-medium text-[var(--geist-background-100)]"
                      >
                ...
                <button
                  @click="closeDetail"
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center btn-ghost btn-icon"
                  :aria-label="t('common.close')"
                >
                  <Icon name="x" size="md" />
                </button>
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-[var(--geist-background-100)] px-8 py-8 dark:bg-[var(--geist-background-100)]">
              <!-- Content with decorative border -->
              <div class="relative">
                <!-- Decorative left border -->
                <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-[var(--geist-foreground-100)]"></div>
                <div class="pl-6">
                  <div
            ...
            <div class="border-t border-[var(--geist-border-100)] bg-[var(--geist-background-200)] px-8 py-5 dark:border-[var(--geist-border-100)] dark:bg-[var(--geist-background-200)]">
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  <button
                    @click="closeDetail"
                    class="btn btn-secondary px-5 py-2.5 text-sm"
                  >
                    {{ t('common.close') }}
                  </button>
                  <button
                    ...
                    class="rounded-xl btn btn-primary px-5 py-2.5 text-sm"
                  >
