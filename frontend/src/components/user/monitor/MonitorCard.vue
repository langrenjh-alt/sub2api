<template>
  <button
    type="button"
    class="group text-left p-5 rounded-lg min-h-[280px] w-full bg-white/70 backdrop-blur-xl border border-gray-200/80 shadow-card dark:bg-dark-800/60 dark:border-dark-700/70 hover:-translate-y-1 dark:hover:border-primary-500/30 hover:border-gray-300 transition-all duration-300 ease-out flex flex-col"
    @click="emit('click')"
  >
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="mt-0.5 flex items-center gap-1.5 min-w-0">
          ...
          <span
            ...
            class="inline-flex items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium bg-[var(--geist-background-300)] text-[var(--geist-foreground-300)] dark:bg-[var(--geist-background-300)] dark:text-[var(--geist-foreground-300)] flex-shrink-0"
          >
            {{ item.group_name }}
          </span>
        </div>
    ...
    <!-- Divider -->
    <div class="mt-4 border-t border-[var(--geist-border-100)] dark:border-[var(--geist-border-100)]"></div>
