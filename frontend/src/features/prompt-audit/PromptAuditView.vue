<template>
  <AppLayout>
    ...
    <div v-if="draft && activeTab === 'config'" class="fixed inset-x-0 bottom-0 z-30 border-t border-gray-200 bg-white px-4 py-3 shadow-[0_-12px_35px_rgba(15,23,42,0.08)] dark:border-dark-700/80 dark:bg-dark-900 dark:shadow-[0_-12px_35px_rgba(0,0,0,0.35)] lg:left-64">
