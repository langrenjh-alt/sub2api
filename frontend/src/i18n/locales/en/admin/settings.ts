export default {
    settings: {
      ...
      payment: {
        ...
        field_tradeType: 'Default Trade Type',
        field_tradeTypeHint: 'Fallback trade type when the user does not pick a chain. Checkout chain selection takes priority.',
        field_networks: 'Checkout Networks',
        field_networksHint: 'USDT chains shown on the payment page, such as TRON, BSC, Ethereum, and Solana. Enable only networks that already have a receiving wallet in BEpusdt.',
        field_fiat: 'Fiat Currency',
        field_currencies: 'Allowed Cryptocurrencies',
        field_address: 'Receiving Address',
        field_timeout: 'Order Timeout (seconds)',
        field_rate: 'Exchange Rate Override',
        ...
        field_bepusdtApiBaseHint: 'BEpusdt base URL, for example https://pay.example.com',
