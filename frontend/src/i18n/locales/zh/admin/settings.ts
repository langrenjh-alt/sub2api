export default {
    settings: {
      ...
      payment: {
        ...
        field_tradeType: '默认交易类型',
        field_tradeTypeHint: '用户未选择链时的回退类型。收银台链选择优先于该值。',
        field_networks: '可用支付链',
        field_networksHint: '用户在支付页可选择的 USDT 链，例如 TRON / BSC / Ethereum / Solana。请只勾选 BEpusdt 已配置收款钱包的网络。',
        field_fiat: '法币类型',
        field_currencies: '允许的加密货币',
        field_address: '收款地址',
        field_timeout: '订单超时时间（秒）',
        field_rate: '汇率覆盖值',
        ...
        field_bepusdtApiBaseHint: 'BEpusdt 服务地址，例如 https://pay.example.com',
