export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_secretKeyX20: 'Payment Form Secret Key X20',
        field_clientId: 'Client ID',
        field_apiKey: 'API Key',
        field_publishableKey: 'Publishable Key',
        field_webhookSecret: 'Webhook Secret',
        field_payeePurse: 'Payee Purse',
        field_paymentUrl: 'Payment Form URL',
        field_allowSdp: 'Allowed Payment Method',
        field_hold: 'Hold Period',
        field_simMode: 'Simulation Mode',
        ...
        field_payeePurseHint: 'WebMoney WMZ receiving purse, for example Z123456789012.',
        field_webmoneySecretKeyHint: 'Secret Key used to verify WebMoney Result URL callbacks. Keep it private.',
        field_webmoneySecretKeyX20Hint: 'Optional 50-character X20 key used to generate LMI_PAYMENTFORM_SIGN for the WebMoney payment form.',
        field_paymentUrlHint: 'WebMoney Merchant UTF-8 form endpoint. Default: https://merchant.wmtransfer.com/lmi/payment_utf.asp.',
        field_allowSdpHint: 'LMI_ALLOW_SDP. 31=Alipay P2P, 28=USDT, 27=Ethereum, 26=Litecoin, 19=Bitcoin, 29=bank card P2P.',
        field_webmoneyHoldHint: 'Optional LMI_HOLD value in days. Leave empty unless your WebMoney merchant setup requires payment hold.',
        field_simModeHint: 'LMI_SIM_MODE: 0=all test payments succeed, 1=all test payments fail, 2=80% success / 20% fail.',
        field_webmoneyCurrencyHint: 'WebMoney defaults to USD / WMZ settlement. If you choose another currency, make sure the receiving purse and merchant settings match it.',
  ...
  payment: {
    ...
    errors: {
      ...
      WEBMONEY_CONFIG_MISSING_KEY: 'WebMoney config missing required key: {key}.',
      WEBMONEY_CONFIG_INVALID_PURSE: 'WebMoney {key} is invalid.',
      WEBMONEY_CONFIG_INVALID_SIM_MODE: 'WebMoney {key} must be 0, 1, or 2.',
      WEBMONEY_CONFIG_INVALID_X20: 'WebMoney {key} must be exactly {expected} characters.',
      WEBMONEY_CONFIG_INVALID_HOLD: 'WebMoney {key} must be a positive integer.',
      WEBMONEY_CONFIG_INVALID_CURRENCY: 'WebMoney currency is invalid.',
