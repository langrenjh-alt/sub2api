                ...
                <div v-else class="flex flex-wrap gap-1">
                  ...
                  >
                    <input
                      ...
                      class="h-3 w-3 rounded border-gray-300 text-primary-600 focus:ring-[var(--geist-foreground-300)]"
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <label
                      ...
                      :class="rule.group_ids.includes(gid)
                        ...
                        : 'border-gray-200 hover:bg-gray-50 dark:border-dark-600 dark:hover:bg-dark-700'"
                    >
                      <input type="checkbox" :checked="rule.group_ids.includes(gid)" class="h-3 w-3 rounded border-gray-300 text-primary-600 focus:ring-[var(--geist-foreground-300)]" @change="rule.group_ids.includes(gid) ? rule.group_ids.splice(rule.group_ids.indexOf(gid), 1) : rule.group_ids.push(gid)" />
