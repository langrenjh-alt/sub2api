...
async function loadAllSettings() {
  ...
  try {
    ...
    // 相容舊 payload：後端未返回該欄位時補預設值，保證表單可繫結
...
// OpenAI 帳號配額自動暫停：後端按 0~1 分數儲存，UI 按百分比(0~100)展示
