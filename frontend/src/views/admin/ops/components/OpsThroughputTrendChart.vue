...
<template>
  <div class="flex h-full min-w-0 flex-col card p-6">
    <div
    ...
    >
      ...
      >
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="inline-flex shrink-0 items-center rounded-lg border border-gray-200 bg-white px-2 py-1 text-[11px] font-semibold text-gray-600 hover:bg-[var(--geist-background-200)] disabled:opacity-50 dark:border-dark-700 dark:bg-[var(--geist-background-200)] dark:text-gray-300 dark:hover:bg-dark-800"
    ...
    <div v-if="(props.topGroups?.length ?? 0) > 0" class="mb-3 flex flex-wrap gap-2">
      <button
        ...
        :key="g.group_id"
        type="button"
        class="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-1 text-[11px] font-semibold text-gray-700 hover:bg-[var(--geist-background-200)] dark:border-dark-700 dark:bg-[var(--geist-background-200)] dark:text-gray-200 dark:hover:bg-dark-800"
