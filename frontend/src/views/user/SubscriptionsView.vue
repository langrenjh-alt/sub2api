    ...
    <div class="space-y-6">
      ...
      <div v-else class="grid gap-6 lg:grid-cols-2">
        ...
        >
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-[var(--geist-border-100)] p-4 dark:border-[var(--geist-border-100)]"
          >
          ...
          <div class="space-y-4 p-4">
            ...
            <div
              v-if="
                ...
                !subscription.group?.monthly_limit_usd
              "
              class="flex items-center justify-center rounded-lg bg-[var(--geist-background-200)] py-6 dark:bg-[var(--geist-background-200)]"
            >
              <div class="flex items-center gap-3">
