<template>
  <component :is="isPopup ? 'div' : AppLayout" :class="isPopup ? 'min-h-screen bg-[var(--geist-background-200)]' : ''">
      ...
      <template v-else>
        ...
        <div v-if="order" class="card overflow-hidden">
          <div class="bg-[#635bff] px-6 py-6 text-center">
            <p class="text-sm font-medium text-white">{{ t('payment.actualPay') }}</p>
        ...
        <template v-if="wechatQrUrl">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4">
              ...
              <div class="relative rounded-lg border-2 border-gray-300 bg-white p-4 dark:border-gray-600 dark:bg-dark-800">
                <img :src="wechatQrUrl" alt="WeChat Pay QR" class="h-56 w-56 rounded" />
                <div class="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <span class="rounded-full bg-[#2BB741] p-2">
        ...
        <template v-else-if="redirecting">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4 py-4">
              <div class="h-10 w-10 animate-spin rounded-full border-4 border-gray-400 border-t-transparent"></div>
