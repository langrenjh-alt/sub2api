  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <template v-else>
        ...
        <div v-if="tabs.length > 1 && paymentPhase === 'select' && !selectedPlan" class="tabs flex space-x-1 p-1">
              ...
              <div v-if="activeSubscriptions.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="sub in activeSubscriptions" :key="sub.id"
                    class="flex items-center gap-3 rounded-lg border border-[var(--geist-border-100)] bg-[var(--geist-background-100)] px-3 py-2 dark:border-[var(--geist-border-100)] dark:bg-[var(--geist-background-100)]">
    ...
    <Teleport to="body">
      <Transition name="modal">
        <div v-if="showRenewalModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" @click.self="closeRenewalModal">
          <div class="relative flex max-h-full w-full max-w-lg flex-col rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-700 dark:bg-dark-900">
            <!-- Close button -->
    ...
    <Teleport to="body">
      <Transition name="modal">
        <div v-if="previewImage" class="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 backdrop-blur-sm" @click="previewImage = ''">
          <img :src="previewImage" alt="" class="max-h-[85vh] max-w-[90vw] rounded-xl object-contain shadow-sm" />
        </div>
      </Transition>
    </Teleport>
  </AppLayout>
