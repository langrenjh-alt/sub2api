<template>
  <div class="flex min-h-screen items-center justify-center bg-[var(--geist-background-200)] p-4 text-[var(--geist-foreground-100)]">
    <div
      class="card w-full max-w-md space-y-4 p-6"
    >
      <!-- Amount + Order ID -->
