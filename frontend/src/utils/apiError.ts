 ...
 * Example: "certSerial" → t('admin.settings.payment.field_certSerial') → "證書序列號".
 */
 ...
 * localized UI labels (e.g. "證書序列號"), using the provider-config field i18n namespace.
 ...
 * "缺少必填項：證書序列號" instead of "缺少必填項：certSerial".
 *
