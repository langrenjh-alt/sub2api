...
const BADGE: Record<Platform, string> = {
  ...
  composite: 'bg-gray-500/10 text-gray-700 border-gray-500/30 dark:text-gray-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  composite: 'bg-gray-500/10 text-gray-700 dark:bg-gray-500/10 dark:text-gray-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  composite: 'border-gray-300 dark:border-dark-600',
}
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  composite: 'border-gray-400/40 dark:border-gray-500/30',
}
...
const ACCENT: Record<Platform, string> = {
  ...
  composite: '#737373', // gray-500 (was cyan)
}
const ACCENT_DEFAULT = '#525252' // neutral gray (was primary teal)
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  composite: 'bg-gradient-to-r from-gray-500 to-gray-600',
}
...
const TEXT: Record<Platform, string> = {
  ...
  composite: 'text-gray-700 dark:text-gray-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  composite: 'bg-gray-700 text-white hover:bg-gray-800 active:bg-gray-900 dark:bg-gray-600 dark:hover:bg-gray-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  composite: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  composite: 'from-gray-600 to-gray-700',
}
