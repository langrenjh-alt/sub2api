...
func (*Ticket) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case ticket.FieldID, ticket.FieldUserID, ticket.FieldCreatedBy, ticket.FieldClosedBy:
			values[i] = new(sql.NullInt64)
		case ticket.FieldTitle, ticket.FieldStatus:
			values[i] = new(sql.NullString)
		case ticket.FieldClosedAt, ticket.FieldLastReplyAt, ticket.FieldCreatedAt, ticket.FieldUpdatedAt:
