...
// AddAnnouncementCommentIDs adds the "announcement_comments" edge to the AnnouncementComment entity by IDs.
func (_u *UserUpdate) AddAnnouncementCommentIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddAnnouncementCommentIDs(ids...)
	return _u
}

// AddAnnouncementComments adds the "announcement_comments" edges to the AnnouncementComment entity.
func (_u *UserUpdate) AddAnnouncementComments(v ...*AnnouncementComment) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddAnnouncementCommentIDs(ids...)
}
...
// ClearAnnouncementComments clears all "announcement_comments" edges to the AnnouncementComment entity.
func (_u *UserUpdate) ClearAnnouncementComments() *UserUpdate {
	_u.mutation.ClearAnnouncementComments()
	return _u
}

// RemoveAnnouncementCommentIDs removes the "announcement_comments" edge to AnnouncementComment entities by IDs.
func (_u *UserUpdate) RemoveAnnouncementCommentIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveAnnouncementCommentIDs(ids...)
	return _u
}

// RemoveAnnouncementComments removes "announcement_comments" edges to AnnouncementComment entities.
func (_u *UserUpdate) RemoveAnnouncementComments(v ...*AnnouncementComment) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveAnnouncementCommentIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AnnouncementCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AnnouncementCommentsTable,
			Columns: []string{user.AnnouncementCommentsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedAnnouncementCommentsIDs(); len(nodes) > 0 && !_u.mutation.AnnouncementCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AnnouncementCommentsTable,
	...
	if nodes := _u.mutation.AnnouncementCommentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AnnouncementCommentsTable,
...
// AddAnnouncementCommentIDs adds the "announcement_comments" edge to the AnnouncementComment entity by IDs.
func (_u *UserUpdateOne) AddAnnouncementCommentIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddAnnouncementCommentIDs(ids...)
	return _u
}

// AddAnnouncementComments adds the "announcement_comments" edges to the AnnouncementComment entity.
func (_u *UserUpdateOne) AddAnnouncementComments(v ...*AnnouncementComment) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAnnouncementComments clears all "announcement_comments" edges to the AnnouncementComment entity.
func (_u *UserUpdateOne) ClearAnnouncementComments() *UserUpdateOne {
	_u.mutation.ClearAnnouncementComments()
	return _u
}

// RemoveAnnouncementCommentIDs removes the "announcement_comments" edge to AnnouncementComment entities by IDs.
func (_u *UserUpdateOne) RemoveAnnouncementCommentIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveAnnouncementCommentIDs(ids...)
	return _u
}

// RemoveAnnouncementComments removes "announcement_comments" edges to AnnouncementComment entities.
func (_u *UserUpdateOne) RemoveAnnouncementComments(v ...*AnnouncementComment) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
