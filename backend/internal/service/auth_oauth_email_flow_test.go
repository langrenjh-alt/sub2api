...
func TestSendPendingOAuthVerifyCode_NonWhitelistDomainLimit(t *testing.T) {
	...
	_, err := authService.SendPendingOAuthVerifyCode(context.Background(), "second@custom.example", "", "", GeetestChallenge{})
	require.ErrorIs(t, err, ErrEmailDomainRegistrationLimit)
}
...
func TestSendPendingOAuthVerifyCode_NonWhitelistDomainRejectedWhenQuotaDisabled(t *testing.T) {
	...
	_, err := authService.SendPendingOAuthVerifyCode(context.Background(), "first@custom.example", "", "", GeetestChallenge{})
...
func TestSendPendingOAuthVerifyCode_NilServiceReturnsUnavailable(t *testing.T) {
	...
	_, err := authService.SendPendingOAuthVerifyCode(context.Background(), "fresh@example.com", "", "", GeetestChallenge{})
