...
func TestAuthServiceVerifyCaptchaForPendingOAuthCreateReusesConsumedGeetest(t *testing.T) {
	verifier := &geetestVerifierStub{}
	settingService, geetestService := newGeetestServiceForTest(map[string]string{
		SettingKeyGeetestEnabled:    "true",
		SettingKeyGeetestCaptchaID:  "id",
	...
	require.NoError(t, authService.VerifyCaptchaForPendingOAuthCreate(
		context.Background(),
		CaptchaProof{},
		"127.0.0.1",
		"123456",
