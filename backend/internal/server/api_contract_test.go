		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyGeetestEnabled:     "true",
					service.SettingKeyGeetestCaptchaID:   "captcha-id",
					service.SettingKeyGeetestCaptchaKey:  "captcha-key",
					...
					service.SettingKeyHomepageStatusEnabled:  "true",
					service.SettingKeyHomepageStatusGroupIDs: "[12,3]",
			...
			wantJSON: `{
				...
				"data": {
					...
					"homepage_status_group_ids": [12, 3],
