...
func TestChannelMonitorV2ScopeFailsClosedForOrdinaryViewerWithoutAuthorizationDependency(t *testing.T) {
	...
	filter := service.ChannelMonitorV2Filter{}
	// Zero value, not NewChannelMonitorV2Handler(nil, nil): a typed nil
	// *service.APIKeyService stored in the authorizer interface is not == nil.
	h := &ChannelMonitorV2Handler{}
